...
CORE_SCRIPT_FILENAME = "Final Integration.py"
...
def detect_from_recorded_video_dashboard(video_path: str, run_dir: str, callbacks: Optional[DashboardCallbacks] = None) -> Dict[str, str]:
    ...
    while True:
        ...
        if frame_idx % VID_STRIDE == 0:
            ...
            logger.preview(last_display_frame)
...
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
CORE_SCRIPT_FILENAME = "Final Integration.py" # Adjusted to match your uploaded filename
CORE_SCRIPT_PATH = os.path.join(SCRIPT_DIR, CORE_SCRIPT_FILENAME)
...
def detect_from_live_stream_dashboard(stream_url: str, run_dir: str, callbacks: Optional[DashboardCallbacks] = None) -> Dict[str, str]:
    ...
    ACCIDENT_CONF_THRESHOLD = 0.915 #Used to be 0.9
    VEHICLE_CONF_THRESHOLD = 0.5 #Used to be 0.65
    REQUIRED_DETECTIONS = 5
    DETECTION_WINDOW_SEC = 5
    VID_STRIDE = 4 #This was 4 before
    PRE_EVENT_SEC = 5
    POST_EVENT_SEC = 5
    BUFFER_SEC = PRE_EVENT_SEC + 2
    COOLDOWN_SEC = 15
